...
{
	CUSTOMVERTEX vtex[] = {
		{       0.0f,        0.0f, 0.5f, 1.0f, m_color[0], m_tuMin, m_tvMin },
		{ m_texWidth,        0.0f, 0.5f, 1.0f, m_color[1], m_tuMax, m_tvMin },
		{ m_texWidth, m_texheight, 0.5f, 1.0f, m_color[2], m_tuMax, m_tvMax },
		{       0.0f, m_texheight, 0.5f, 1.0f, m_color[3], m_tuMin, m_tvMax },
	};
...
{
	CUSTOMVERTEX vtex[] = {
		{ -m_texWidth, -m_texheight, 0.5f, 1.0f, m_color[0], m_tuMin, m_tvMin },
		{  m_texWidth, -m_texheight, 0.5f, 1.0f, m_color[1], m_tuMax, m_tvMin },
		{  m_texWidth,  m_texheight, 0.5f, 1.0f, m_color[2], m_tuMax, m_tvMax },
		{ -m_texWidth,  m_texheight, 0.5f, 1.0f, m_color[3], m_tuMin, m_tvMax },
	};
